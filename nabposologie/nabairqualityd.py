...
class Nabposologie(NabInfoCachedService):
    ...
    async def get_config(self):
        ...
        return (
            ...
            (
                config.index_posologie,
                config.visual_posologie,
                latitude,
                longitude,
            ),
        )
    ...
    async def fetch_info_data(self, config_t):
        ...
        index_posologie, visual_posologie, latitude, longitude = config_t
        client = aqicn.aqicnClient(index_posologie, latitude, longitude)
        try:
        ...
        return {
            "visual_posologie": visual_posologie,
    ...
    def get_animation(self, info_data):
        ...
        if (
            (info_data is None)
            or (info_data["visual_posologie"] == "nothing")
            or (
                info_data["visual_posologie"] == "alert"
